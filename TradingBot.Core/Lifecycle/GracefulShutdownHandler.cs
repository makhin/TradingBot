...
/// </summary>
public class GracefulShutdownHandler : IGracefulShutdownHandler
{
    private readonly IStateManager<BotState> _stateManager;
    private readonly ILiveTrader _trader;
